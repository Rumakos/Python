...
# b = [el for i, el in enumerate(a) if a[i] > a[i - 1]]
# print(b[1:])
...
# Тут нужно использовать from math import factorial. Соотвественно можете пройтись с помощью for полученными значениями.
...
#         yield temp
#
# n = int(input("Input n for factorial calculation: "))
# for el in fact(n):
#     print(el)
